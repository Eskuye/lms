...
<body>
		...
		<div class="register">
			...
			<form action="index.php" method="post">
				...
				<!-- <select name="Category" id="Category">
					<option value="GEN" hidden>General</option>
					<option value="OBC" hidden>OBC</option>
					<option value="SC" hidden>SC</option>
					<option value="ST" hidden>ST</option>
				</select> -->
				<br>
	...
	<div class="footer w3layouts agileits">
		<p><b class="copyright">&copy; 2021 Library Management System</b></p>
