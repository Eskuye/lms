                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav pull-right">
                            <li class="nav-user dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="images/userr.png" class="nav-avatar" />
                                <b class="caret"></b></a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="student.php"><i class="menu-icon icon-user"></i>Manage Employees</a>
                                </li>
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Rollno"><b>Receiver Employee No:</b></label>
                                            <div class="controls">
                                                <input type="text" id="RollNo" name="RollNo" placeholder="Employee No" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2021 Library Management System</b>
            </div>
        </div>
